    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row mb-2" id="content1" style="color: black;">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4" id="customerCount"></div>
                <div class="col-sm-12 col-md-4 col-lg-4" id="totalSum"></div>
            </div>
            <hr class="divider d-md-block bg-dark" />
            <div class="table-responsive">
                <p style="color:black;"> Select date to get Customer Sales Reports<span style="color: red;">*</span></p>
            </div>
        </div>
    </div>
</div>
        ...
        $('#filter').click(() => {
            ...
            if (from_date != '' && to_date != '') {
                if (from_date < to_date) {
                    ...
                    $.ajax({
                        url: 'ajaxOpra/totalAmtPaid_customerCount.php',
                        method: 'POST',
                        dataType: 'json',
                        data: {
                            from_date: from_date,
                        ...
                        success: function(data) {
                            ...
                            $('#totalSum').html("Total Amount Paid: " + data.total);
                            $('#customerCount').html("Number of Customers: " + data.row);
                            $('#content1').show();
                    ...
                    $('#print').click(() => {
                        var from_date = $('#from_date').val();
                        var to_date = $('#to_date').val();
                        window.open('utilities/report_print/customerSalesReport_print.php?from_date=' + from_date + '&to_date=' + to_date, '_blank');
                    ...
                    $('#send').click(() => {
                        ...
                        if (email == '' || result == 0) {
                            ...
                            var from_date = $('#from_date').val();
                            var to_date = $('#to_date').val();
                            window.open('utilities/report_email/customerSalesReport_email.php?from_date=' + from_date + '&to_date=' + to_date + '&email=' + email, '_self');
                        }
                    })
                } else {
                    $('#d1_msz').show();
                    ...
                    $('#content1').hide();
                    $('#util').hide();
                    $('.table-responsive').html("<p style='color:black'>Select date to get Customer Sales Reports<span style='color:red;'>*</span></p>");
                }
            } else {
                $('#d_msz').show();
