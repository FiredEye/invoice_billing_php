...
try {
    ...
    $attachment = $pdf->Output('Unpaid invoice report.pdf', 'S');
    ob_end_flush();


    //Attachments
    $mail->addStringAttachment($attachment, 'Unpaid invoice report.pdf');
    //Add attachments


    //Content
    $body = 'Unpaid invoice report';
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Unpaid Invoice Report';
    $mail->Body    = $body;
...
?> <script>
            location.replace('../../unpaid_report.php');
